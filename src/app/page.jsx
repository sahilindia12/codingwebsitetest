...
import Dromanu from './componett/Dromanu';
import DropdownMenu from './componett/Dromanu';
...
<DropdownMenu  />
      ...
      <Link href={'./reactnetive/react-netive-apk'}>apk file </Link>    <br/>
      ...
      <Link href={'./docker/dockerinstall'}>docker</Link>   <br/>
